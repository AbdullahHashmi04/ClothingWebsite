    ...
    >
      <div
        style={{
          height: "240px",
          background:
            "linear-gradient(90deg,#f3e8ff 25%,#faf5ff 50%,#f3e8ff 75%)",
    ...
    >
      <div
        ...
        style={{
          ...
          flexDirection: "row",
          boxShadow:
            "0 40px 120px rgba(147,51,234,0.28), 0 8px 32px rgba(0,0,0,0.2)",
      ...
      >
        ...
        >
          ...
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = cfg.gradient;
          ...
          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
            ...
            <div
              style={{
                ...
                alignItems: "center",
                gap: "6px",
                background: `${regionCfg.color}12`,
                border: `1px solid ${regionCfg.color}30`,
                borderRadius: "100px",
                padding: "5px 14px",
              }}
            >
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = `0 14px 32px ${cfg.tag}55`;
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = "none";
              e.currentTarget.style.boxShadow = `0 8px 24px ${cfg.tag}40`;
            }}
          >
            Close details ✕
          </button>
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to top, rgba(255,255,255,0.4) 0%, transparent 55%)",
            pointerEvents: "none",
          }}
        />
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
          ...
          >
            <span style={{ color: cfg.tag, fontWeight: 600 }}>
              {item.popular_in}
            </span>
          </span>
        </div>
        ...
        <div
          style={{ height: "1px", background: "#f3e8ff", margin: "2px 0" }}
        />
...
export default function TrendingPage() {
  ...
  const fetchTrends = useCallback(async (region) => {
    ...
    const cacheKey = `trending_${region}`; // unique key per region

    // 1. Try cache first — show data immediately if available
    const cached = getCached(cacheKey);
    if (cached) {
      setItems(cached);
      setLoading(false); // don't show spinner if we have data
    ...
    try {
      ...
      setCached(cacheKey, data); // save to cache before setting state
      setItems(data);
    } catch (e) {
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background:
            "linear-gradient(160deg,#0d0014 0%,#1a003a 50%,#0a0024 100%)",
      ...
      >
        ...
        >
          Live fashion culture across Pakistan's 8 distinct regions — from
          Lahore's phulkari to GB's felt coats
        </p>
      ...
      >
        ...
        {loading && (
          ...
          >
            ...
            >
              Loading {activeRegion === "All" ? "all regions" : activeRegion}{" "}
              trends…
            </p>
            <div
              style={{
        ...
        {!loading && error && (
          <ErrorState
            message={error}
            onRetry={() => fetchTrends(activeRegion)}
          />
        )}
